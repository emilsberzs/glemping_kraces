"""
Django settings for kraces project.
...
SECRET_KEY = ')@s3exz4=d#nw$kl^pudidq^c5^6f@tl$nym46l=$g)v@oz%5u'
...
WSGI_APPLICATION = 'kraces.wsgi.application'
